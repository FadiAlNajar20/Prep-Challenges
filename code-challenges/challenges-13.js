...
const objectCounter = (obj) => {
    ...
    let result = obj.reduce((accumulator, currentvalue) => ++accumulator, 0)
    return result;
}
// -------------------------------------------------------------------------------------------------------
...
const stringReverse = (str) => {
    // write your code here
    let arr = str.split(' ');
    let result = arr.reduce((acc, curr) => { return curr + ' ' + acc; });
    return result;
}
// -------------------------------------------------------------------------------------------------------
...
const statistics = (obj) => {
    // write your code here
    let result = obj.reduce((accumulator, currentvalue) => {
        if (currentvalue.votes_To in accumulator) {
