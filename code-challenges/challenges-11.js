...
function square(arr) {
    ...
    return arr.map((number)=>{return number * number});
}
// -------------------------------------------------------------------------------------------------------
...
function fullName(arr) {
    // write your code here
    let combinedName = arr.map((student)=>{return (student.firstName + ' ' + student.lastName)})
  return combinedName
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    // write your code here
    let calculate = arr.map((grad)=>{
        let sum = 0;
        grad.gradsList.forEach(index =>{
          sum += index;
        })
