...
const LastWord = (str) => {
    ...
    let word = str.lastIndexOf(" ");
    let lastWord = str.slice(word + 1);
      return lastWord;
}
// -------------------------------------------------------------------------------------------------------
...
const LastWord_2 = (str) => {
    // write your code here
    let getLastWord = str.split(" ")
    return getLastWord[getLastWord.length -1];
}
// -------------------------------------------------------------------------------------------------------
...
const replaceWords = (str) => {
    // write your code here
    let string = ["We", "are", "were"];
    let string2 = ["I", "am", "was"];
    let firstUseSplit = str.split(' ');
      string2.forEach((word, i)=>{
    let result = firstUseSplit.indexOf(word);
    if(result != -1){
    console.log(result);
    let spliceWord = firstUseSplit.splice(result, 1, string[i]);
        return spliceWord; 
    }})
}
// -------------------------------------------------------------------------------------------------------
