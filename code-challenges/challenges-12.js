...
const oddFiltration = (arr) => {
    ...
    let oddNumber = arr.filter(odd => odd % 2);
    return oddNumber
}
// -------------------------------------------------------------------------------------------------------
...
const cvsFiltration = (arr) => {
    // write your code here
    let fullName = '';
    let candidates = arr.filter((cv) => cv.yearsOfExperience > 4 && cv.tech == "JS").map((cv) => {
        fullName = cv.firstName + " " + cv.LastName
        if (cv.firstName == null) {
            fullName = cv.LastName;
        } else if (cv.LastName == null) {
...
const vowelsFiltration = (arr) => {
    // write your code here
    let regex = /[aeiou]/i;
    let words = arr.filter((vowels) => !regex.test(vowels))
    return words
}
// -------------------------------------------------------------------------------------------------------
